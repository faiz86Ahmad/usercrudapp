                ...
                <CardContent>
                    ...
                    <div className="row">
                        <div className="left_view col-lg-6 col-md-6 col-12">
                            <img src={userIcon} style={{ width: 50 }} alt="profile" />
                            <h3 className="mt-3">Name: <span >{getuserdata.name}</span></h3>
                            <h3 className="mt-3">Role: <span >{getuserdata.role}</span></h3>
                            <p className="mt-3"><MailOutlineIcon />Email: <span>{getuserdata.email}</span></p>
                            <p className="mt-3"><WorkIcon />Plan: <span>{getuserdata.plan}</span></p>
                            <p className="mt-3">Status: <span>{getuserdata.status}</span></p>
                        </div>
